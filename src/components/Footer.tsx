      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="text-2xl font-bold text-gradient mb-4">Taylor Labs</div>
            <p className="text-white/70 max-w-md mb-6">
              Taylor Labs is a tech innovation company focused on building 
              products that solve real-world problems and delight users.
            </p>
            <div className="flex space-x-4">
              <a 
                href="#" 
                className="p-2 rounded-full bg-dark-800 hover:bg-primary transition-colors" 
                aria-label="Twitter"
              >
        ...
        <div className="border-t border-dark-700 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/50 text-sm">
            © {currentYear} Taylor Labs. All rights reserved.
          </p>
