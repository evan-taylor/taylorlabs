  ...
  return (
    <section id={id} ref={sectionRef} className="py-20 md:py-28 relative" aria-labelledby="products-heading">
      ...
      <motion.div
        ...
        whileHover={{ y: -5 }}
      >
        <div className="grid md:grid-cols-2 gap-0 max-w-full">
          <div className="p-4 sm:p-8 md:p-12">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-gray-700 mb-4 break-words">Never worry about accidental sound leaks again.</p>
              ...
              <div className="flex flex-wrap gap-2 sm:gap-4">
                <Button
                  className="bg-purple-600 hover:bg-purple-700 rounded-full px-3 sm:px-6 text-sm sm:text-base"
                  onClick={() =>
                    window.open(
          ...
          <motion.div
            className="relative min-h-[300px] sm:min-h-[400px] bg-gradient-to-br from-[#f8f9fa] to-[#e9ecef] flex items-center justify-center overflow-hidden"
